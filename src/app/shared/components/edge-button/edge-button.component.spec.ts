...
describe('EdgeButtonComponent', () => {
  ...
  it('should apply correct CSS classes based on inputs', () => {
    ...
    const expectedClasses = 'edge-button edge-button--large edge-button--secondary edge-button--disabled';
    expect(component.buttonClasses).toBe(expectedClasses);
  });

  it('should update input values when changed', () => {
    fixture.componentRef.setInput('text', 'Custom Edge Button');
    fixture.componentRef.setInput('disabled', true);
    fixture.detectChanges();
    
    expect(component.text()).toBe('Custom Edge Button');
    expect(component.disabled()).toBe(true);
  });

  it('should render text correctly', () => {
    fixture.componentRef.setInput('text', 'Start Timer');
    fixture.detectChanges();
    
    const buttonElement = fixture.nativeElement.querySelector('button');
    expect(buttonElement.textContent.trim()).toContain('Start Timer');
  });
});